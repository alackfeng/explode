...
export const APP_FOREVER_USER_QUIT = 'APP_FOREVER_USER_QUIT';
...
export const appUserQuit = (username, keys = []) => action(APP_FOREVER_USER_QUIT, { username, keys });
...
export const triggerTrans = {
  handle: ((username, method, parameters = {}, requiredFields = []) => action(TRIGGER_TRANSACTION_COMMON, {
    username, method, parameters, requiredFields,
  })),
