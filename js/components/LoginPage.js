...
export class LoginPage extends Component {
  ...
  onChangePassword = (text) => {
	...
	onSubmit = (e) => {
	  ...
	  const {
	    username, password, errorName, errorPass,
	  } = this.state;
  ...
  <ViewContainer>
    ...
    >
      ...
      <View style={{ flex: 1, alignItems: 'flex-start', backgroundColor: 'transparent' }}>
        <View style={{
 flex: 1, marginTop: 0, alignItems: 'center', backgroundColor: 'transparent',
}}
        >
          <Button
      ...
      <View style={{
 flex: 0.7, backgroundColor: 'transparent', marginTop: 0, width: SCREEN_WIDTH * 0.8,
}}
      >
