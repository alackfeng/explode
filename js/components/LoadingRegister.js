...
class TransactionDetails extends Component {
  transDetails() {
    ...
    const rows = entity.transaction.map((item, index) => {
...
class LoadingRegister extends Component {
  ...
  showRegStatus = () => {
    ...
    */
    ...
    return {
      ok: entityOk, err: entityErr, req: entityReq, evt: entityEvt,
    };
  }
 ...
 flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginBottom: 0,
          ...
          {showBtn && <View style={{ flexDirection: 'row', flex: 1 }}>
            <Button
              ...
              clear
              textStyle={{
 color: 'rgba(35, 81, 162, 1)', fontSize: 18, fontWeight: 'bold', marginTop: 10,
}}
