...
class UsersBox {
  ...
  createAccountWithPassword = ( login, {username, password, registrar, referrer, referrer_percent, refcode}=regInfo ) => {
    ...
    if(login !== username) {
        console.error("=====[users.box.js]::createAccountWithPassword - wrong username : ", login, username);
    ...
    console.log("=====[users.box.js]::createAccountWithPassword - create account:", account_name, active_private.toWif());
    ...
    let create_account = () => {
      return application_api.create_account(
        ...
        return WalletDb.process_transaction(
            ...
            console.log("=====[users.box.js]::createAccountWithPassword - process_transaction then", res);
            // 设置到WalletDb
            return {
                response: res,
            ...
            console.log("=====[users.box.js]::createAccountWithPassword - process_transaction catch", err);
            //Promise.reject(err);
